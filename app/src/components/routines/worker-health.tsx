...
export function WorkerHealth() {
  ...
  const labels: Record<string,string> = {database:"Banco de dados",scheduler:"Worker de rotinas",notifications:"Notificações",history:"Histórico local",runs:"Execuções sem atraso",handoffs:"Delegações sem atraso ou tentativas esgotadas",piWatches:"Acompanhamentos Pi sem atraso ou tentativas esgotadas"};
