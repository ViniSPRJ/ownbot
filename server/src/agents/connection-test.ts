...
function probeBody() {
  return {
    threadId: `ownbot-connection-test-${crypto.randomUUID()}`,
    runId: `ownbot-connection-test-${crypto.randomUUID()}`,
    messages: [
      {
        id: crypto.randomUUID(),
        role: "user",
        content:
          "This is an automated connection test from OwnBot. Reply with one short word.",
      },
    ],
    tools: [],
    context: [],
