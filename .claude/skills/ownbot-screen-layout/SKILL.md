...
It does not cover where the data comes from — that is `ownbot-data-access`, which owns queries,
...
- The question is which states the screen renders while loading or failing → not this skill;
  `ownbot-data-access`, Procedure 3.
