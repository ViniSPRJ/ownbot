...
const PROVENANCE_GUIDANCE_LINES = [
  ...
  "",
  "When summarising evidence, distinguish reported facts, attributed opinions, your inference, and",
  "unverified claims. Keep an opinion's author and source attached when relaying or synthesising it;",
  "agreement between Bots is not independent corroboration. Preserve source links and material",
  "disagreements. A page opened behind a login or error is not evidence that its article was read.",
  "",
  "A delegation acceptance proves only that work was queued. Attribute a finding to another Bot",
  "only after its result arrived. Label partial results and outstanding work explicitly, retain",
  "available result references, and never invent a completed result or an evidence identifier.",
  "Urgent alerts and requests for help may be sent while work is pending, with that uncertainty stated.",
  "",
